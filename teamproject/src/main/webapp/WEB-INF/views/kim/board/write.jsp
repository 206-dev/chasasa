...
<body class="bg-white text-black min-h-screen p-4">
    <main class="grid grid-cols-3 gap-4 mt-4">
        <section class="col-span-2 space-y-4">
            <form id="frmRegister" role="form" action="/kim/board/writeRun" method="post" enctype="application/x-www-form-urlencoded">
            	<input type="hidden" name="userid" value="${loginSessionDto.userid}">
                <input type="hidden" name="nickname" value="${loginSessionDto.nickname}">
                <input type="hidden" id="content" name="content" required>
                <%-- <input type="hidden" name="boardtypeno" value="${boardtype.boardtypeno}"> --%>
        ...
        <aside class="space-y-4">
            <div class="bg-gray-100 p-4">
				<div
					class="flex items-center justify-between p-2 bg-gray-300 rounded">
